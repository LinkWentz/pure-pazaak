...
function TurnOverlay(props){
    return(
        <div className="TurnOverlay">
            ...
            <Overlay className="yourCardPlayedOverlay" visible={(props.gameState["boards"]["you"]["sidedeckCardPlayed"] || props.inputDisabled) && props.gameState.turn == 'you'}/>
            <Overlay className="opponentsCardPlayedOverlay" visible={props.gameState["boards"]["opponent"]["sidedeckCardPlayed"] && props.gameState.turn == 'you'}/>
        </div>
    )
}
